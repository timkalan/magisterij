...
delovanja Schnorrovega podpisa v grupi $\Z_p^*$.
...
najti dva različna niza z enako zgostitvijo. Natančno zgoščevalne funkcije definiramo:
...
\begin{definicija}[Zanemarljiva funkcija~\cite{boneh2023appcry}]
    ...
    $$
    V nadaljevanju bomo v $\varepsilon$ označevali poljubno zanemarljivo funkcijo.
\end{definicija}
...
problem, ki ima eksponentno časnovno zahtevnost glede na $k$. To implicira, da je verjetnost uspeha
...
Hevristika torej deluje samo v modelu slučajnega oraklja. Zadostnot interaktivnega protokola se
