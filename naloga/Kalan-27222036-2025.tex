...
\todo{dokaz varnosti: dokažem forking lemmo že tu? Se da dokazati tudi v standardnem modelu? Je treba
prek prevajanja iz identifikacijske sheme?}
...
\todo{natančneje o zkp: sigma protocols, \\ zero knowledge proof (of knowledge) fiat-shamir}
...
znanja. Izkaže pa se, da če $P_j$ dokaz izračuna s $q$ klici slučajnega oraklja, potem simulator 
...
sopodpisnikov in njihove zaveze. Brez teh podatkov namreč dokaz znanja ni preverljiv. To pomeni, da je 
za katerokoli podskupino $S$ velikost ključa proporcionalna velikosti celotne skupine $G$. Poleg 
tega mora sedaj preverjevalec preveriti, da se vsi vektorji javnih ključev ujemajo. V primerjavi 
...
Vrednostim se zavežemo tako, da preverjevalcu damo vrednost korena. Ko mu kasneje želimo razkriti vrednosti, 
