...
je, kakšne prednosti ponuja pred uporabo več navadnih Schnorrovih podpisov. Najočitnejša prednost
...
\begin{itemize}
    ...
    \item \textbf{Drugi krog}:
        ...
        $$
        y = \sum_{i=1}^L y_i \bmod p = \mathcal{S}\mathcal{A}_2(y_i | 1 \le i \le L).
        $$
