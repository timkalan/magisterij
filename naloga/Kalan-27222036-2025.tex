...
\begin{dokaz}
    ...
    $$
    \Omega = \{x \in X \text{ }|\text{ Pr}((x, y) \in A) \geq \epsilon / 2\}.
    $$
    Neposredno iz definicije množice sledi drugi del leme: če je $a$ v $\Omega$, mora zanj veljati
    $\text{Pr}((a, y) \in A) \geq \epsilon / 2$. Za prvi del leme pa uporabimo izrek o popolni verjetnosti, 
    da $\text{Pr}((x, y) \in A)$ razdelimo:
    \begin{align*}
        \text{Pr}((x, y) \in A) &= \text{Pr}(x \in \Omega) \cdot
                                    \text{Pr}((x, y) \in A \text{ }|\text{ } x \in \Omega) \\
                                &+ \text{Pr}(x \notin \Omega) \cdot
                                    \text{Pr}((x, y) \in A \text{ }|\text{ } x \notin \Omega)
    \end{align*}
    Zaradi definicije množice $\Omega$ velja $\text{Pr}((x, y) \in A \text{ }|\text{ } x \in \Omega)
    \geq \epsilon / 2$ in $\text{Pr}(A(x, y) \text{ }|\text{ } x \notin \Omega) < \epsilon / 2$.
    Zapišemo lahko torej
    \begin{align*}
        \epsilon &\leq \text{Pr}((x, y) \in A) \\
