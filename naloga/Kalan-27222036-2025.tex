...
\begin{itemize}
    ...
    \item \textbf{Prilagodljivost}: Simulator in napadalec med seboj komunicirata. Pogosto je potrebno,
        da simulator prilagodi svoje odločitve na podlagi napadalčevih odločitev. Zato mora biti
        sposoben ">previti"< napadalca nazaj na prejšnje stanje, potencialno prilagoditi svoj
        odgovor in ponovno simulirati korak sheme.
\end{itemize}
...
da velja $g^s \equiv I \pmod q$. Ideja je, da $A$ simulira podpisovanje za šibkega napadalca $F'$,
