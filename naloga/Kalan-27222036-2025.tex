...
\begin{primer}[Reševanje sudokuja]
    ...
    Znano je, da je ta problem NP-poln, kar pomeni, da je težko najti rešitev, vendar je enostavno
    preveriti, če je rešitev pravilna. Če želi dokazovalec prepričati preverjevalca, da zna rešiti
    vse Sudokuje, lahko to storita tako, da si preverjevalec izbere naključne Sudokuje, jih pošlje
    dokazovalcu, ta pa jih reši in vrne rešitve. Preverjevalec nato preveri, če so rešitve pravilne.
...
Dokazi znanja brez razkritja znanja (definicija, primer dl)
