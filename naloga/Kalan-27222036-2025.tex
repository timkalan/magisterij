...
neodvisno in naključno izbere skrivno število $s_i \in \Z_q$ in izračuna 
$$ 
I_i = g^{s_i} \bmod p.
$$
...
o varnosti je standardna predpostavka o težavnosti diskretnega logaritma, prilagojena za
multiplikativne grupe
$\Z_p^*$.

\begin{definicija}[Predpostavka o težavnosti diskretnega logaritma pri ASM]
\label{def:asm_dlp}
