...
\subsection{Kriptografski podpis}
\subsubsection{RSA}

\subsection{Schnorrov podpis}

\subsubsection{Ustvarjanje ključa}
Kot pri vsakem podpisu, mora podpisnik najprej generirati zasebni in javni ključ. Najprej mora 
naključno izbrati dve praštevili $p, q \in \mathbb{P}$ tako, da $q$ deli $p-1$. Potem izbere še 
naključni element $g$ reda $q$ iz grupe $\mathbb{Z}_p^*$.

\subsubsection{Podpisovanje}

\subsubsection{Verifikacija podpisa}
