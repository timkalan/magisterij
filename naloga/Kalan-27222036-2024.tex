...
\begin{definicija}[Večstranski podpis (podskupine z odgovornostjo)] 
    ...
    \begin{itemize}
        ...
        \item $\mathcal{S}$ je algoritem za podpisovanje. Pognan je vsakič, ko neka podskupina $S$ želi 
            ...
            objavi podpis $\sigma$.
            $$ 
            \mathcal{S}_i((id_1, \dots, id_l), (\text{pk}_{id_1}, \dots, \text{pk}_{id_l}), m, \text{sk}_i) = \sigma,
            $$
...
si lahko privošči vstopiti v podpisovanje kot eden izmed igralcev $P_L$, in lahko zadnji generira svoj
